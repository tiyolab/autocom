...
<div class="side">
	  <div class="sidebar-wrapper">
	 	 <ul>	  
			...
			<li>
			  <a href="<?= Url::to(['logistik/jenis-kendaraan'])?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Jenis Kendaraan">
			  <i class="fa fa-list-alt"></i>
			  </a>
			</li>
			<li>
			  <a href="<?= Url::to(['logistik/status-kendaraan'])?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Monitoring Status Kendaraan">
				<i class="fa fa-wrench"></i>
			  </a>
			</li>
			<li>
				<a href="<?= Url::to(['logistik/ongkos-kirim'])?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Ongkos Kirim">
			...
			<li>
				<a href="<?= Url::to(['logistik/approve'])?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Approve Pengiriman">
				<i class="fa fa-key"></i>
			  </a>
			</li>
			<li>
				<a href="<?= Url::to(['logistik/penjadwalan'])?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Penjadwalan Pengiriman">
				<i class="fa fa-calendar"></i>
			  </a>
			</li>
			<li>
				<a href="<?= Url::to(['logistik/report'])?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Report Pengiriman">
