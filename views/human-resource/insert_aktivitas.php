				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">									
							...
							<?= Html::input("text", "aktivitas", null, ["placeholder"=>"Aktivitas", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Tanggal Aktivitas", ["class"=>"form-control"]) ?>						
							<?= Html::input("date", "tanggal", null, ["required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Hasil Aktivitas", ["class"=>"form-control"]) ?>						
							<?= Html::input("text", "hasil_aktivitas", null, ["placeholder"=>"Hasil Aktivitas", "required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
