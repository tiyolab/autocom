...
$this->title = 'Tambah Lembur Pegawai';
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">									
							...
							<?= Html::input("text", "kegiatan", null, ["placeholder"=>"kegiatan", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Durasi", ["class"=>"form-control"]) ?>						
							<?= Html::input("number", "durasi", null, ["placeholder"=>"Durasi", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Tanggal Lembur", ["class"=>"form-control"]) ?>						
							<?= Html::input("date", "tanggal_lembur", null, ["placeholder"=>"Tanggal Lembur", "required"=>"required", "class"=>"form-control"]) ?>				
