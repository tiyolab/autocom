				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">									
							...
							<?= Html::input("number", "jumlah_tempat", null, ["placeholder"=>"Jumlah Tempat", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Tanggal Tawaran", ["class"=>"form-control"]) ?>						
							<?= Html::input("date", "tgl_tawaran", null, ["required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Batas Akhir", ["class"=>"form-control"]) ?>						
							<?= Html::input("date", "batas_akhir", null, ["required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
