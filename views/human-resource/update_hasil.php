...
$myData = HrdHasil::find()->where(['id_hasil_tes'=>Yii::$app->request->get()['id']])->asArray()->one();
$this->title = 'Edit Hasil Tes';
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<?= Html::input("number", "hasil_tes", $myData['hasil_tes'], ["placeholder"=>"Hasil Tes", "required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
