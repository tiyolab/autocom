...
$this->title = 'Tambah Data Pelamar';
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<?= Html::input("text", "nama", null, ["placeholder"=>"Nama Pelamar", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Tempat Lahir", ["class"=>"form-control"]) ?>						
							<?= Html::input("text", "tempat_lahir", null, ["placeholder"=>"Tempat Lahir", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Tanggal Lahir", ["class"=>"form-control"]) ?>						
							<?= Html::input("date", "tgl_lahir", null, ["placeholder"=>"Tanggal Lahir", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Pendidikan Terakhir", ["class"=>"form-control"]) ?>						
							<?= Html::input("text", "pend", null, ["placeholder"=>"Pendidikan Terakhir", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Alamat", ["class"=>"form-control"]) ?>						
							<?= Html::input("text", "alamat", null, ["placeholder"=>"Alamat", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "No HP", ["class"=>"form-control"]) ?>						
							<?= Html::input("number", "hp", null, ["placeholder"=>"No Hp", "required"=>"required", "class"=>"form-control"]) ?>
							...
							<?= Html::input("date", "tgl_daftar", null, ["required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
