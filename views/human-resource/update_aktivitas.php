...
$myData = Hrdaktivitas::find()->where(['id_aktivitas'=>Yii::$app->request->get()['id']])->asArray()->one();
$this->title = 'Edit Aktivitas Pegawai';
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">									
							...
							</br><?= Html::label( "Aktivitas", ["class"=>"form-control"]) ?>						
							<?= Html::input("text", "aktivitas", $myData['aktivitas'], ["placeholder"=>"Aktivitas", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Tanggal Aktivitas", ["class"=>"form-control"]) ?>						
							<?= Html::input("date", "tanggal", $myData['tanggal'], ["required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Hasil Aktivitas", ["class"=>"form-control"]) ?>						
							<?= Html::input("text", "hasil_aktivitas", $myData['hasil_aktivitas'], ["placeholder"=>"Hasil Aktivitas", "required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
