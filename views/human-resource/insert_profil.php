				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<?= Html::input("number", "nip", null, ["placeholder"=>"NIP", "required"=>"required", "class"=>"form-control"]) ?>						
							</br><?= Html::label( "Nama", ["class"=>"form-control"]) ?>
							<?= Html::input("text", "nama_lengkap", null, ["placeholder"=>"Nama", "required"=>"required", "class"=>"form-control"]) ?>						
							</br><?= Html::label( "Gelar Depan", ["class"=>"form-control"]) ?>
							<?= Html::input("text", "gelar_dpn", null, ["placeholder"=>"Gelar Depan", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Gelar Belakang", ["class"=>"form-control"]) ?>
							<?= Html::input("text", "gelar_blk", null, ["placeholder"=>"Gelar Belakang", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Agama", ["class"=>"form-control"]) ?>
							<?= Html::input("text", "agama", null, ["placeholder"=>"Agama", "required"=>"required", "class"=>"form-control"]) ?>
							...
							<?= Html::input("number", "tinggi", null, ["placeholder"=>"Tinggi (Kg)", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Berat", ["class"=>"form-control"]) ?>
							<?= Html::input("number", "berat", null, ["placeholder"=>"Berat (Kg)", "required"=>"required", "class"=>"form-control"]) ?>
							...
							<?= Html::input("textarea", "alamat", null, ["placeholder"=>"Alamat", "required"=>"required", "class"=>"form-control"]) ?>
							...
							<?= Html::input("number", "nomor_telepon", null, ["placeholder"=>"Nomor Telepon", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Jumlah Tanggungan", ["class"=>"form-control"]) ?>
							<?= Html::input("number", "jml_tanggungan", null, ["placeholder"=>"Jumlah Tanggungan", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Pendidikan Terakhir", ["class"=>"form-control"]) ?>
							<?= Html::input("text", "pendidikan_terakhir", null, ["placeholder"=>"Pendidikan Terakhir", "required"=>"required", "class"=>"form-control"]) ?>	
							...
							<?= Html::input("date", "tanggal_diterima", null, ["placeholder"=>"Tanggal Diterima", "required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
