...
$this->title = 'Tambah Data Prestasi Pegawai';
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">		
							...
							<?= Html::input("text", "prestasi", null, ["placeholder"=>"Prestasi / Penghargaan", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Instansi Pemberi Penghargaan", ["class"=>"form-control"]) ?>						
							<?= Html::input("text", "instansi_pemberi", null, ["placeholder"=>"Instansi Pemberi Penghargaan", "required"=>"required", "class"=>"form-control"]) ?>
							</br><?= Html::label( "Tanggal Diperoleh", ["class"=>"form-control"]) ?>						
							<?= Html::input("date", "tgl_diperoleh", null, ["placeholder"=>"Tanggal Diperoleh", "required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
