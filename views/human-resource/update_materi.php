...
$myData = HrdMateri::find()->where(['id_materi_tes'=>Yii::$app->request->get()['id']])->asArray()->one();
$this->title = 'Edit Materi Tes : '.$myData['materi_tes'];
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							</br><?= Html::label( "Lowongan Jabatan", ["class"=>"form-control"]) ?>
							...
							<?= Html::input("text", "materi_tes", $myData['materi_tes'], ["placeholder"=>"Materi Tes", "required"=>"required", "class"=>"form-control"]) ?>
						</div>
						<div class="form-group">
