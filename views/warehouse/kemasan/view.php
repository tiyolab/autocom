    ...
    <div class="widget widget-green">
        <div class="widget-title">
            ...
            <div class="widget-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="kemasan-view">

                            <h1><?= Html::encode($this->title) ?></h1>

                            <p>
                                <?= Html::a('Update', ['update', 'id' => $model->Kemasan_ID], ['class' => 'btn btn-primary']) ?>
                                <?= Html::a('Delete', ['delete', 'id' => $model->Kemasan_ID], [
