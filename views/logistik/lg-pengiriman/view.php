...
$findapprove = new LgPengiriman();

/* @var $this yii\web\View */
/* @var $model app\models\logistic\LgPengiriman */

$this->title = 'Monitoring Pengiriman: ' . ' ' . $model->kode;
        ...
        <div class="widget-title">
            ...
            <div class="widget-content">
                <div class="row">
                    <div class="col-md-12">
                        <p>      
                            <?= Html::a('back', Yii::$app->urlManager->createUrl(['logistik/pengiriman']), ['class' => 'btn btn-success']) ?>
                        </p>

                        <table class="table">
                            <tbody>
                                <?php $i=1; foreach ( $findapprove->findDetailPengiriman($model->kode) as $key => $value) { ?>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Kurir</td><td><?=$value['nama_lengkap']?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php 
                                            if($value['status_approve']==0){echo"<span class='label label-warning'>waiting</span>";}
                                            else if($value['status_approve']==1){echo"<span class='label label-success'>approved</span>";}
                                             ?>
                                             </td>
                                        </tr>
                                        <tr>
